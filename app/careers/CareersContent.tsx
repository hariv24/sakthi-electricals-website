...
export default function CareersContent({ bannerUrl = '/assets/banners/careers.jpg' }: { bannerUrl?: string }) {
    ...
    <>
      <main style={{ flex: 1 }}>
        ...
        <section className="page-hero hero-photo">
          <div className="hero-bg" style={{ backgroundImage: `url('${bannerUrl}')`, backgroundPosition: "center 40%" }} />
