...
export default async function FacilitiesPage() {
  const media = await getSiteMedia(['facilities_banner', 'facilities_floor', 'facilities_sol1', 'facilities_sol2']);
  return (
    <>
      <main style={{ flex: 1 }}>

        <section className="page-hero hero-photo">
          <div className="hero-bg" style={{ backgroundImage: `url('${media.facilities_banner}')`, backgroundPosition: "center 55%" }} />
        ...
        <FacilitiesFloorSection floorImg={media.facilities_floor} />
        <FacilitiesProcessSection />
        <FacilitiesSolutionsSection sol1Img={media.facilities_sol1} sol2Img={media.facilities_sol2} />
        <FacilitiesCTASection />
