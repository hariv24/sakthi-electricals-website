...
export default function ContactContent({ bannerUrl = '/assets/banners/contact.jpg' }: { bannerUrl?: string }) {
    ...
    <>
      <main style={{ flex: 1 }}>
        ...
        <section className="page-hero hero-photo">
          <div className="hero-bg" style={{ backgroundImage: `url('${bannerUrl}')`, backgroundPosition: "center 30%" }} />
